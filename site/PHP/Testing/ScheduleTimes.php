...
for ($i=0; $i < count($IDs); $i++){
	$sqlstart = "select start from Timeslot where Sections_course_Master_List_id = ".$IDs[$i];
...
for ($i=0; $i < count($IDs); $i++){
	$sqlend = "select end from Timeslot where Sections_course_Master_List_id = ".$IDs[$i];
...
for ($i=0; $i < count($IDs); $i++){
	$sqlDOW = "select DOW from Timeslot where Sections_course_Master_List_id = ".$IDs[$i];
